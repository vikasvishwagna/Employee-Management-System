...
<div className='bg-[#1C1C1C] mt-5 p-5 rounded'>
        ...
        <div id='left-div' className='w-1/2 p-5'>
          ...
          <div id='right-div' className='w-2/5  mt-5 flex flex-col items-start'>
            ...
            type="text" placeholder='Detailed description of task(Max 500 word)' />

            <button className='bg-emerald-400 w-full px-1 py-2
          text-white mt-8 rounded-md  text-xl font-medium cursor-pointer'>Create Task</button>
          </div>
    </form>
  </div>  )
}
